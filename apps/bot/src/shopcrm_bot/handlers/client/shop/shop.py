...
from shopcrm_bot.handlers.client.shop.render_product import show_product_card
from shopcrm_bot.handlers.client.shop.render_shop import render_shop_menu
